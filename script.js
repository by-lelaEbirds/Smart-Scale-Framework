document.addEventListener('DOMContentLoaded', () => {
    ...
    function executarSimulacao() {
        ...
        simularBtn.style.background = "var(--orange-accent)";
    ...
    // --- CORREÇÃO AQUI: Lógica de conversão agora é garantida (sem aleatoriedade) ---
    function executarOferta(option) {
        ...
        if (option === 'A') {
            ...
            // RECUSA GARANTIDA
            addToLog("RESULTADO: Cliente recusou a Oferta B.");
            // Nenhum indicador é atualizado
        }
        
        // Limpa a tela de ofertas em ambos os casos
    ...
    function resetarSimulacao() {
        ...
        simularBtn.style.background = "var(--blue-accent)";
