document.addEventListener('DOMContentLoaded', () => {
    ...
    function applyTheme(theme) {
        ...
        if (demandChart) {
            setupCharts(); // Apenas recria os gráficos
        }
    }
    ...
    // --- CORREÇÃO AQUI ---
    // A chamada para criar os gráficos agora é a última coisa a acontecer,
    // garantindo que o tema já foi aplicado e tudo está pronto.
    setupCharts();
});
