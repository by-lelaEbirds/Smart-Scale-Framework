document.addEventListener('DOMContentLoaded', () => {
    ...
    function setupCharts() {
        ...
        // Define cores fixas do tema claro
        ...
        demandChart = new Chart(demandCtx, {
            ...
            data: {
                ...
                datasets: [
                    { label: 'Vendas Históricas', data: currentState.demandHistory, borderColor: 'rgba(172, 172, 174, 1)', tension: 0.4, borderWidth: 2 }, 
        ...
        sentimentChart = new Chart(sentimentCtx, {
            ...
            data: {
                ...
                datasets: [{ data: currentState.sentiment, backgroundColor: ['rgba(52, 199, 89, 0.8)', 'rgba(142, 142, 147, 0.8)', 'rgba(255, 59, 48, 0.8)'], borderColor: '#ffffff', borderWidth: 4 }]
            },
